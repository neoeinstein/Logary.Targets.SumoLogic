...
let project = "Logary.Targets.SumoLogic"

// Short summary of the project
// (used as description in AssemblyInfo and as a short summary for NuGet package)
let summary = "A Logary target for the SumoLogic log management and data analytics service"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "This package provides a target for the Logary logging library to push logs to a SumoLogic HTTP source collector."

// List of author names (for NuGet package)
let authors = [ "Marcus Griep" ]

// Tags for your project (for NuGet package)
let tags = "sumologic logary logging log logs metrics"

// File system information
let solutionFile  = "Logary.Targets.SumoLogic.sln"
...
let gitName = "Logary.Targets.SumoLogic"
